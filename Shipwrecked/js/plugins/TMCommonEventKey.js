 ...
 *
 * @help
 * Common event key ver1.0.2
 *
 * How to use:
 *
 * Set the number of the common event you want to fire in the plugin parameter,
 * If you press the corresponding key in the map scene, the common event will be executed.
 *
 *  Common event keys are disabled in the following situations:
 *  ・ Scene switching
 *  ・ Player is moving
 *  ・ Event is running
 *
 ...
 * Caution:
 *
 * If you use the standard functions of RPG Maker MV or the keys used in other plug-ins
 * It causes an error due to a conflict.
 */
