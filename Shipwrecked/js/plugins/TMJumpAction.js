...
(function() {
  ...
  var actStepAnimeConstantA = +(parameters['stepAnimeConstantA'] || 0.15);
  ...
  Game_CharacterBase.prototype.initMembers = function() {
    ...
    this._CurrentAnimation = Animations.WALK;
  ...
  Game_CharacterBase.prototype.changeAnimation = function(RequestedAnimation) {
    ...
    var CharacterSheetToLoad = Animations.fileNames[RequestedAnimation]
  ...
  Game_Player.prototype.updateAnime = function() {
    if (this._attacking) {
      this._attackLength++;
      if (this._attackLength > this._attackFrames) {
        this._attackLength = 0;
        this._attacking = false;
      }
    }
      ...
      this.changeAnimation(Animations.FALL);
    }
    else if (this._vy == 0 && this._vx == 0) {
      this.changeAnimation(Animations.STAND);
    }
    else if (this._vy == 0) {
      this.changeAnimation(Animations.WALK);
    }
  }
  ...
  Game_Player.prototype.attackByInput = function() {
    if (this._shotDelay > 0) {
      ...
      if (Input.isTriggered('attack') && n > 0) {
        ...
        //testing event attack animation
        $gameTemp.reserveCommonEvent(22);

        //testing attack animation -- WORKS
        this._attacking = true;
        this.changeAnimation(Animations.KNIFE);
  ...
  Game_Player.prototype.jumpByInput = function() {
    ...
    if (Input.isTriggered('jump')) {
      ...
      this.changeAnimation(Animations.JUMP);
      //testing jump animation
